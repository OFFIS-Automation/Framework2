    ...
    ui(new Ui::CreatePluginDialog)
{
    ...
    QSettings settings;
    QString path = settings.value("VisionGuiPlugin/userPluginDir", QDir::homePath()).toString();
    QString pluginName = settings.value("VisionGuiPlugin/userPluginName", QString("CustomPlugin")).toString();
    QDir dir(path);
...
void CreatePluginDialog::createPlugin()
{
    ...
    QSettings settings;
    settings.setValue("VisionGuiPlugin/userPluginDir", dirName);
    settings.setValue("VisionGuiPlugin/userPluginName", project);
