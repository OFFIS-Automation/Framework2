...
namespace port
{
    class FILTER_PORTS_SHARED_EXPORT Image : public Port
    {
    public:
...
namespace out
{
    class FILTER_PORTS_SHARED_EXPORT Image : public port::Image
    {
    public:
        Image();
    ...
    class FILTER_PORTS_SHARED_EXPORT GrayImage : public port::Image
    {
    public:
        GrayImage();
    ...
    class FILTER_PORTS_SHARED_EXPORT RgbImage : public port::Image
    {
    public:
        RgbImage();
    ...
    class FILTER_PORTS_SHARED_EXPORT RgbaImage : public port::Image
    {
    public:
        RgbaImage();
