...
namespace port
{
    class FILTER_PORTS_SHARED_EXPORT File: public Port
    {
    public:
...
namespace out
{
    class FILTER_PORTS_SHARED_EXPORT File: public  port::File
    {
    public:
...
namespace in
{
    ...
    class FILTER_PORTS_SHARED_EXPORT ReadFile :  public File
    {
    public:
        ReadFile();
    };

    class FILTER_PORTS_SHARED_EXPORT WriteFile :  public File
    {
       public:
        WriteFile();
    };
